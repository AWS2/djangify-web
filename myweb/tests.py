...
class MyseleniumTests(StaticLiveServerTestCase):
    ...
    def check_url(self, open_home, btn, url, open_window):
    ...
    def login_success(self):
        ...
        self.selenium.find_element(By.NAME, "username").send_keys("sample_user")
        self.selenium.find_element(By.NAME, "email").send_keys("sample@gmail.com")
        self.selenium.find_element(By.NAME, "password").send_keys("sample_pwd")
        self.selenium.find_element(By.NAME, "password_confirm").send_keys("sample_pwd")
        time.sleep(2)
        ...
        # Try to log in
        self.login(usr="sample_user", pwd="sample_pwd")
